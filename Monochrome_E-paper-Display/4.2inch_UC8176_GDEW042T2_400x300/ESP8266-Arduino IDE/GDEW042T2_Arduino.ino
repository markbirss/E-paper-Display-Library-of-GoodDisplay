...
void loop() {
  while(1)
  {
    ...
    PIC_display(gImage_1);//1.Refresh background color  
    EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!! 
    delay(2000); //2s  
    EPD_init_Fast(); //EPD init
    PIC_display(gImage_2);//1.Refresh background color  
    EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!! 
    delay(2000); //2s 
    EPD_init(); //EPD init
    PIC_display(gImage_3);//1.Refresh background color  
    EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!!     
    delay(2000); //2s  
...
void EPD_sleep(void)
{
    ...
    lcd_chkstatus();          //waiting for the electronic paper IC to release the idle signal
    delay(100);      //Power off time delay, this is  necessary!!!     
