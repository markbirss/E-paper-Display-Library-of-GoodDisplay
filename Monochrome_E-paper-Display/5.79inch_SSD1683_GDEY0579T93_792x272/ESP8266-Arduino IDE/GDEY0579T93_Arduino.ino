...
void EPD_WhiteScreen_ALL_Fast(const unsigned char *datas)
{
  ...
  for(i=0;i<Source_BYTES*Gate_BITS;i++)
   {          
     tempOriginal=pgm_read_byte(&datas[templine*Source_BYTES*2+tempcol]);
     templine++;
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         ...
         tempData=pgm_read_byte(&datas[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);  
  ...
  Epaper_Write_Data(y_start1);
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         //Byte image processing   
         tempData=pgm_read_byte(&datasA[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);   
         data1=(tempData>>7&0x01)+(tempData>>5&0x02)+(tempData>>3&0x04)+(tempData>>1&0x08)+(tempData<<7&0x80)+(tempData<<5&0x40)+(tempData<<3&0x20)+(tempData<<1&0x10); //×Ö½ÚÄÚÊý¾Ý·´Ðò
         Epaper_Write_Data(~data1); 
  ...
  Epaper_Write_Data(y_start1);
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         //Byte image processing 
         tempData=pgm_read_byte(&datasB[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);   
         data1=(tempData>>7&0x01)+(tempData>>5&0x02)+(tempData>>3&0x04)+(tempData>>1&0x08)+(tempData<<7&0x80)+(tempData<<5&0x40)+(tempData<<3&0x20)+(tempData<<1&0x10); //×Ö½ÚÄÚÊý¾Ý·´Ðò
         Epaper_Write_Data(~data1); 
  ...
  Epaper_Write_Data(y_start1);
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         //Byte image processing 
         tempData=pgm_read_byte(&datasC[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);   
         data1=(tempData>>7&0x01)+(tempData>>5&0x02)+(tempData>>3&0x04)+(tempData>>1&0x08)+(tempData<<7&0x80)+(tempData<<5&0x40)+(tempData<<3&0x20)+(tempData<<1&0x10); //×Ö½ÚÄÚÊý¾Ý·´Ðò
         Epaper_Write_Data(~data1); 
  ...
  Epaper_Write_Data(y_start1);
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         //Byte image processing
         tempData=pgm_read_byte(&datasD[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);   
         data1=(tempData>>7&0x01)+(tempData>>5&0x02)+(tempData>>3&0x04)+(tempData>>1&0x08)+(tempData<<7&0x80)+(tempData<<5&0x40)+(tempData<<3&0x20)+(tempData<<1&0x10); //×Ö½ÚÄÚÊý¾Ý·´Ðò
         Epaper_Write_Data(~data1); 
  ...
  Epaper_Write_Data(y_start1);
   ...
   for(i=0;i<PART_COLUMN;i++)
      for(j=0;j<PART_LINE/8;j++)
       {   
         //Byte image processing     
         tempData=pgm_read_byte(&datasE[i*(PART_LINE/8)+(PART_LINE/8)-j-1]);   
         data1=(tempData>>7&0x01)+(tempData>>5&0x02)+(tempData>>3&0x04)+(tempData>>1&0x08)+(tempData<<7&0x80)+(tempData<<5&0x40)+(tempData<<3&0x20)+(tempData<<1&0x10); //×Ö½ÚÄÚÊý¾Ý·´Ðò
         Epaper_Write_Data(~data1); 
