...
//////////////////////Partial refresh time demo/////////////////////////////////////
    ...
    EPD_SetRAMValue_BaseMapFast(gImage_basemap); //Partial refresh background color     
    ...
    {
        EPD_Dis_Part_myself(152,92,(unsigned char *)&Num[miao_L],         //x-A,y-A,DATA-A
                            152,124,(unsigned char *)&Num[miao_H],         //x-B,y-B,DATA-B
                            152,156,(unsigned char *)gImage_numdot,       //x-C,y-C,DATA-C
                            152,188,(unsigned char *)&Num[fen_L],         //x-D,y-D,DATA-D
                            152,220,(unsigned char *)&Num[fen_H],32,64);  //x-E,y-E,DATA-E,Resolution 32*64
